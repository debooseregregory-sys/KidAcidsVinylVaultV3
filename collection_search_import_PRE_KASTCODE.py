...
def search_collection_release(group):
    ...
    print("Artist :", collection_artist)
    print("Label  :", group["label_catalog"])
    ...
    catalog = normalize(group.get("code", ""))
    label_catalog = normalize(group.get("label_catalog", ""))

    # ========================================================
    # 1. CATALOGUS IS DE BELANGRIJKSTE ZOEKING
    # ========================================================

    if catalog:

        print()
        print("CATALOGUS ZOEKEN:", catalog)
...
def calculate_release_match(
    ...
    for track in get_real_tracks(group):
    ...
    for item in release.get("tracklist", []):
    ...
    # TRACK MATCHING
    #
    # TRACK TITLE IS MORE IMPORTANT THAN TRACK ARTIST
    #
    # We deliberately do NOT require artist_match().
    # This is important for:
    #
    # Untitled
    # Various Artists
    # VA releases
    # releases where Discogs omits track artists
    # ========================================================
    ...
    for collection_track in collection_tracks:
        ...
        wanted_title = collection_track["title"]
        ...
        for index, discogs_track in enumerate(
            ...
            actual_title = discogs_track["title"]
    ...
    # CATALOG MATCH
    #
    # Normalize catalog values much more carefully.
    #
    # D 071
    # D-071
    # D071
    #
    # are treated as the same basic catalog.
    #
    # But:
    #
    # DED-071
    ...
    # WD-0716
    #
    # are NOT accepted as exact matches.
    # ========================================================
    ...
    wanted_label = normalize_compare(
        group.get("label_catalog", "")
    )

    wanted_label_parts = [
        part
        for part in wanted_label
        .replace("(", " ")
        .replace(")", " ")
        .split()
        if len(part) >= 3
    ...
    # Partial meaningful label second
    ...
    if (
        wanted_artist
        and wanted_artist != "various artists"
    ):
    ...
    # HARD PROTECTION
    #
    # A release with zero matching tracks cannot be accepted.
    # ========================================================
...
def verify_discogs_candidates(
    ...
    for candidate in candidates:
        ...
        candidate["_vv_release"] = release; candidate["_vv_discogs_url"] = f"https://www.discogs.com/release/{release_id}"
...
if __name__ == "__main__":
    ...
    candidates = search_collection_release(
        group
    )
    ...
    # ========================================================
    # DISCOGS RELEASES CONTROLEREN
    # ========================================================

    best = verify_discogs_candidates(
        group,
        candidates,
        minimum_score=60
    )
