    ...
    def _build(self):
        ...
        self.setStyleSheet("""
            ...
            QPushButton#cdTrackPlayButton {
                background:#2a1524; color:#ff4fa3; border:1px solid #5a2a48;
                border-radius:10px; padding:4px; font-size:15px; font-weight:900;
            }
            QPushButton#cdTrackPlayButton:hover {
                background:#ff4fa3; color:#0e0e12; border-color:#ff4fa3;
            }
            QPushButton#cdTrackPlayButton[playing="true"] {
                background:#3a1a30; color:#ff6bb5; border-color:#ff4fa3;
            }
